...
SOURCES: list[Source] = [
    ...
    Source(
        ...
        search_url="https://geechs-job.com/project",
        build_search=lambda kw: "https://geechs-job.com/project",
        login_required=False,
        js_required=False,
        parser_key="geechs",
        note="老舗・案件1万件超。静的HTMLでhttpx取得可。/project/details/{id}",
    ),
    Source(
        key="techstock",
        name="テックストック",
        ...
        search_url="https://tech-stock.com/projects/",
        build_search=lambda kw: "https://tech-stock.com/projects/?onlyRecruiting=true",
        login_required=False,
        js_required=False,
        parser_key="techstock",
        note="INTLOOP運営。高単価帯。静的HTML(WordPress)。/projects/details/{id}",
    ),
    Source(
        key="engineer_factory",
        name="エンジニアファクトリー",
        type="Agent",
        priority=14,
        base_url="https://www.engineer-factory.com/",
        search_url="https://www.engineer-factory.com/freelance/jobs/",
        build_search=lambda kw: "https://www.engineer-factory.com/freelance/jobs",
        login_required=False,
        js_required=False,
        parser_key="engineer_factory",
        note="エンド直・高単価。静的HTMLでhttpx取得可。/freelance/jobs/{id}",
    ),
]
